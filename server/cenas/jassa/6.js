...
store.addMap({
    ...
    from: '?s a dbpedia-owl:Castle . Optional { ?s foaf:depiction ?d . ?s dbpedia-owl:owner ?o . ?o rdfs:label ?on . }'
});
...
listService.fetchItems(searchString, 100, 0).then(function(items) { console.log(items); });