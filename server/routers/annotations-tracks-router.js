...
router.post('/', function(req, res) {
	...
	misc.create_resource(E, misc.context, 'ianna', ['oann:AnnotationsTrack'], properties)
		.then((pair) => {
			var uuid = pair.uuid;
...
// Return the tracks for a given board.
...
router.put('/:id', function(req, res) {
	// TODO: permitir alterar o dc:title, dc:description, rdf:type.
})